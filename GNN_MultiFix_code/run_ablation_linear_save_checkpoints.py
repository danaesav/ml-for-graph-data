...
if __name__ == "__main__":
    ...
    early_stopping = EarlyStopping(path_to_checkpoints_folder, model_name=args.model_name, split_name=args.split_name,
    ...
    for epoch in range(args.epochs):
        ...
        if args.multi_class == False:
            ...
            early_stopping(val_loss, model, epoch=str(epoch))
    ...
    # print("model for final eva:")
    # print(args.model_name + "___" + args.split_name + "_" + '_checkpoint_' + str(last_checkpoint) + '.pt')
    # model.load_state_dict(torch.load(args.model_name + "___" + args.split_name + "_" + epoch + '_checkpoint.pt'))
