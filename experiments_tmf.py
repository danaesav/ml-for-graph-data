...
def initialize_models(param):
    ...
    tmf_0 = {'model': model_tmf_0,
          'optimizer': optimizer_tmf_0,
            'type': "tmf"}
    
    model_tmf_1 = TemporalMultiFix(
        input_dim=param["NUM_REL_FEATURES"] + param["NUM_IRR_FEATURES"] + param["NUM_RED_FEATURES"],
        num_of_nodes=param["NUM_NODES"],
        output_dim=param["NUM_LABELS"],
...
def plotting(param, results, datasets, zoom = False):
    ...
    train_datas_tmf_0 = results["tmf0"].train_metrics.metric_list()
    validation_datas_tmf_0 = results["tmf0"].val_metrics.metric_list()

    train_datas_tmf_1 = results["tmf1"].train_metrics.metric_list()
    validation_datas_tmf_1 = results["tmf1"].val_metrics.metric_list()
...
def experiment_main(param):
    ...
    dataset_loader = DatasetLoader(config, param["EMBEDDING_DIM"], filename=param["FILENAME"], load=param["BASEFILE"])
